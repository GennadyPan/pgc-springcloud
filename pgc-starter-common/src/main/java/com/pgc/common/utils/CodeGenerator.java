...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        strategy.setSuperControllerClass("com.pgc.common.base.BaseController");
        strategy.setSuperServiceClass("com.pgc.common.base.BaseService");
        strategy.setSuperServiceImplClass("com.pgc.common.base.BaseServiceImpl");
        strategy.setSuperMapperClass("com.pgc.common.base.BaseDao");
